---
title: "Wrap up March 2026"
date: 2026-04-05T06:50:09-07:00
draft: false
tags: ["monthly", "digest", "automated", "readwise", "foursquare", "letterboxd", "overcast", "strong", "github", "summary", "wrap-up"]
categories: ["Summary"]
---

This is a wrap up and some retro on what I have done in the month of March, 2026.

## Reading

My Readwise stats spiked this month compared to February, but only because I was testing their text-to-speech feature. I already gave up, though; the quality is still too "robotic" and mediocre, making it far too easy to lose focus. It beats standard web readers, but it’s just not engaging enough yet.

Notable articles:

* [Four years on a 4-day workweek](https://www.emgoto.com/four-day-work-week/): unique experience of 4-day work week, but more importantly behind their experience it is the focus of thinking through what they are looking for resonates
* [How to Write Blog Posts that Developers Read](https://refactoringenglish.com/chapters/write-blog-posts-developers-read/): pragmatic and very helpful tips for writing in general.
  * Title + first 2-3 sentences focus: who it is written for and why they should read it
  * Always check if you can broaden the audience with a few tweaks
  * Plan ahead for where/how your posts would reach their readers
  * Bring more pictures (not AI generated though)
  * Make it look good for skimmers (use tools to skimmify the page)
* [So, I Wrote a Book](https://read.thecoder.cafe/p/100-go-mistakes): interesting read for me bc this is my first time reading the “End-to-end” book publishing experience (earnings so low! ratings so high! experience so bad!)

Some highlights:

[Cloudflare: Leading Cybersecurity](https://colossus.com/episode/cloudflare-leading-cybersecurity/):
...
The biggest differentiator of Cloudflare might be that it is serving the long tail - similar to Meta.
...
This will be true and soon there will be “AI-native” companies built by single person. 

## Movies

Last month I happen to watch 2 horror movies full of gore. I don’t know what to say other than it is a lot of gore! I enjoy it to some extent but that’s not something I would actively look for more.

## Workout

I haven’t found a perfect way to track everything yet. The three logged workouts only cover weightlifting via a specific app, leaving my bouldering and surfing sessions off the record. It looks like [Apple Health allows for data exports](https://support.apple.com/guide/iphone/share-your-health-data-iph5ede58c3d/ios) that include fitness metrics, so I’ll try to integrate that next time for a more complete picture.

## Code

It’s been a productive month: 81 commits across 6 repos. 
Much of that work focused on evolving my personal data pipeline. I’ve added a new Apps page to my blog and revamped my monthly reports to move beyond 'just numbers.' I found that raw metrics weren't enough to keep me engaged, so I'm shifting toward detailed breakdowns that allow for a meaningful monthly retrospective. 
On the tooling side, I built [a repo-stat script](https://github.com/yyl/utilities/blob/main/github_repo_stat.py) that intelligently toggles between local analysis and GitHub’s GraphQL API depending on repository size. I also launched [Anyblog](https://anyblog.cc), which I’ve detailed in a separate post.
